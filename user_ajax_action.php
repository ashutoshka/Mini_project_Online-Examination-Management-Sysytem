...
if (isset($_POST['page'])) {
	if ($_POST['page'] == 'register') {
		...
		This is a verification eMail, please click the link to verify your eMail address by clicking this ' . $exam->home_page . 'verify_email.php?type=user&code=' . $user_verfication_code . '
